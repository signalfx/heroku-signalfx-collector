...
func TestProcessLogs(t *testing.T) {
	validInputs := []string{
		...
		// router info log
		"271 <158>1 2019-12-11T16:17:53.786555+00:00 host heroku router - at=info method=GET path=\"/test\" host=aqueous-oasis-14017.herokuapp.com request_id=93bf8b6c-34b1-4eb8-9b5b-f0e72e5ce377 code=H12 fwd=\"76.195.93.225\" dyno=web.1 connect=0ms service=1ms status=404 bytes=146 protocol=https",
		// dyno metricVal logs
	...
	expectedParsedLog := []*logLine{
		{
			...
			Appname:   "heroku",
			ProcId:    "router",
			Message:   "at=info method=GET path=\"/test\" host=aqueous-oasis-14017.herokuapp.com request_id=93bf8b6c-34b1-4eb8-9b5b-f0e72e5ce377 code=H12 fwd=\"76.195.93.225\" dyno=web.1 connect=0ms service=1ms status=404 bytes=146 protocol=https",
		}, {
			PRI:       "45",
			Version:   "1",
